...
/* ======================================================== o DOM de bolso ====
   Ele morava aqui e saiu para `_dom_de_bolso.js` quando `_teste_acompanhar.js`
   passou a precisar do mesmo documento. Copiar seria deixar dois testes julgarem
   o MESMO coletor com reguas que divergem na primeira correcao feita so num
   lado. O que ele prova, e o que ele NAO prova, esta dito la. */
const { documento } = require('./_dom_de_bolso');
